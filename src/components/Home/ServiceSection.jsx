...
const services = [
  {
    title: "PREMIUM SAFE WASH",
    // Title: #B62025 | Desc: #737373
    desc: "A meticulous multi-stage contact wash using grit guards and plush microfibers to ensure a swirl-free finish.",
    image: "/services/safe-wash.avif",
    path: "/services/safe-wash",
    styles: "bg-black text-[#737373] border-l-4 border-[#B62025]"
  },
  {
    title: "DECONTAMINATION WASH",
    // Title: #B62025 | Desc: #737373
    desc: "Deep cleansing that removes iron fallout, tar, and industrial pollutants that regular washing can't touch.",
    image: "/services/decon-wash.avif",
    path: "/services/decontamination",
    styles: "bg-black text-[#737373] border-l-4 border-[#B62025]"
  },
  {
    title: "ENGINE BAY DETAIL",
    // Title: #B62025 | Desc: #737373
    desc: "Safe, precision cleaning and dressing of the engine compartment to remove grease and restore a showroom look.",
    image: "/services/engine-wash.avif",
    path: "/services/engine-detailing",
    styles: "bg-black text-[#737373] border-l-4 border-[#B62025]"
  }
];
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
             ...
             hover:scale-105 active:scale-105 bg-black/60 hover:shadow-primary hover:border-primary/80 dark:bg-black/10 transition-all duration-300"
                data-aos="fade-up"
              ...
              >
                ...
                <div className="max-w-sm mx-auto bg-white ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[65%] mt-15 mx-auto h-40  "
                    onError={(e) => {
